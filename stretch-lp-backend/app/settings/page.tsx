  ...
  return (
    <>
        <div className="relative min-h-screen bg-gray-50 md:flex">
            ...
            {/* メインコンテンツ */}
            <div className="flex-1 w-full md:pl-0 pt-5">
                {/* トップバー（モバイル） */}
                ...
                <div className="px-2 pt-8 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-7xl">
                        ...
                        <p className="mt-1 text-sm text-gray-600">アカウントや通知、プライバシーなどを管理できます。</p>
                    </div>
                </div>

                {/* グリッド */}
                <div className="px-4 pb-12 pt-4 sm:px-6 lg:px-8 pt-">
                    <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                        <SettingCard 
                        title="アカウント設定" 
                        description="名前、メールアドレス、パスワードを変更します。"
                        >
